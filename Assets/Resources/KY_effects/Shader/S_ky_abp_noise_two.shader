...
////// Emissive:
                ...
                float node_5866 = ((pow(_MainTex_var.a,_alphaDensity)*_alphaPower)*i.vertexColor.a*saturate(pow((i.vertexColor.r+i.vertexColor.g+i.vertexColor.b),_vertColorDensity)));
