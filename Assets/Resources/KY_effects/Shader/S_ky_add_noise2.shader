...
Shader "KY/add_noise2" {
    Properties {
        ...
        _noiseTexRot ("noiseTexRot", Float ) = 0
    }
    SubShader {
        Tags {
...
////// Emissive:
                ...
                float node_3822_ang = _noiseTexRot;
                ...
                float2 node_3822 = (mul((i.uv0+(node_2775.g*float2(_noiseTexSpdX,_noiseTexSpdY)))-node_3822_piv,float2x2( node_3822_cos, -node_3822_sin, node_3822_sin, node_3822_cos))+node_3822_piv);
                float4 _noseTex_var = tex2D(_noseTex,TRANSFORM_TEX(node_3822, _noseTex));
